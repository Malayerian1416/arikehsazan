...
@endsection
@section('page_title')
    <span class="laleh external_page_title_text text-muted text-center">مشاهده لیست پروژه ها و ویرایش</span>
@endsection
@section('content')
    ...
    <div class="table-responsive">
        <table class="table table-hover table-bordered iran_yekan index_table" id="main_table" data-filter='["1"]'>
