...
@section('page_title')
    <span class="iran_yekan external_page_title_text text-muted text-center">ایجاد سرفصل منوی جدید</span>
@endsection
@section('content')
    <form id="create_form" action="{{route("MenuHeaders.store")}}" method="post" data-type="create" v-on:submit="submit_form" enctype="multipart/form-data">
        @csrf
        <div class="form-row">
