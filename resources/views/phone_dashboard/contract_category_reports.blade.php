...
@section('scripts')
    <script>
        @if(isset($contract_categories) && isset($contract_category_id))
            let contract_categories = @json($contract_categories);
            let related_data_select = {{$contract_category_id}};
        @endif
    </script>
@endsection
@section('page_title')
    <span class="iran_yekan external_page_title_text text-muted text-center">گزارشات سرفصل پیمان</span>
@endsection
@section('content')
    <form action="{{route("Reports.contract_category_reports_make")}}" method="post">
        @csrf
        <div class="form-row border rounded pb-2">
            ...
            <div class="form-group col-md-12 col-lg-4 col-xl-3">
                ...
                <select class="form-control select_picker iran_yekan @error('contract_branch_id') is-invalid @enderror" title="انتخاب کنید" data-size="10" data-live-search="true" id="contract_branch_id" name="contract_branch_id" v-on:change="related_data_search" data-type="contract_category" ref="parent_select">
            ...
            <div class="form-group col-md-12 col-lg-4 col-xl-3">
                ...
                <select class="form-control select_picker iran_yekan @error('contract_category_id') is-invalid @enderror" title="انتخاب کنید" data-size="10" data-live-search="true" id="contract_category_id" name="contract_category_id" v-model="related_data_select" ref="child_select">
