...
@section('page_title')
    تعیین مجوزهای ویرایش درخواست مرخصی
@endsection
@section('content')
    <form id="create_form" action="{{route("LeaveFlow.set_permissions")}}" method="post" data-type="create" v-on:submit="submit_form">
        @csrf
        <div class="form-row">
            @forelse($leave_flow as $flow)
